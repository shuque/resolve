...
* (as root) pip3 install git+https://github.com/shuque/resolve.git@v0.6.9

To install for your own account:

* pip3 install git+https://github.com/shuque/resolve.git@v0.6.9
